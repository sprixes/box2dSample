...
public class BoneConnection {
	...
	public BoneConnection(Body attachBodyA, Body attachBodyB, World world, int extraLength, boolean elastic, boolean enableCollision) {
		...
		for (float i = 0; i < dist; i += generationStep) {
			...
			/*
			 * fd.density -= 0.8f; if (fd.density < 1.0f) fd.density = 1.0f;
			 */
